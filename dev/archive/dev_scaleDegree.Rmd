...
```{r}
.scaleDegreeWK("D", "G#") == "#4"
.scaleDegreeWK("D", "Db") == "7"
.scaleDegreeWK("D", "C") == "b7"
.scaleDegreeWK("F", "G#") == "#2"
.scaleDegreeWK("B", "C#") == "2"
```
...
```{r}
.intervalScaleDegree("F#", "C")
.intervalScaleDegree("F", "Cb")
```


```{r}
# Returns a base (white note) scale of seven notes given a tonic
...
```{r}
note <- "Cb"; altered_note <- "C#"
# Given a note and an altered version (same letter), find the semitone difference between the two notes
# Note: perhaps simplify function since usage almost always assumes note is a white key (helper for .ISD)
